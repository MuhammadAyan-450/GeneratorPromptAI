  ...
  return (
    <div className="bg-gray-50 min-h-screen flex flex-col">
      ...
      <Helmet>
        ...
        <meta name="twitter:title" content="GeneratorPromptAI - Free AI Tools & 24/7 AI Agent" />
        <meta name="twitter:description" content="Free AI tools with 24/7 AI Agent and prompt generators. No signup, no limits." />
      ...
      {/* Quick Search, Popular Tools, Latest Tools, Blog Teaser etc. */}
      ...
      {/* Popular Tools & Other sections remain unchanged as per your request */}
