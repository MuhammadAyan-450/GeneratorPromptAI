...
const Contact = () => {
  ...
  return (
    <>
      <Helmet>
        {/* Primary SEO */}
        <title>Contact Us - Support & Feedback | Generator PromptAI</title>
        <meta
          name="description"
          content="Get in touch with Generator PromptAI. Report a bug, request a new tool, or just say hello. We typically reply within 24 hours."
        />
        <link rel="canonical" href="https://www.generatorpromptai.com/contact" />
      ...
      <div className="min-h-screen bg-gray-50 pb-20">
        ...
        <div className="max-w-4xl mx-auto px-4">
            ...
            <div className="flex flex-col md:flex-row items-center gap-8 mb-8">
              ...
              <div className="text-center md:text-left flex-1">
                ...
                <p className="text-gray-600">
                  Best and fastest way to reach us. We usually reply within 24 hours.
                </p>
              </div>
            </div>

            <div className="bg-gray-50 border border-gray-100 rounded-xl p-6 text-center">
              <p className="text-sm font-semibold text-gray-500 uppercase tracking-wider mb-2">Email Address</p>
              <a
          ...
          <div className="bg-white border border-gray-200 rounded-3xl p-8 md:p-10 mb-10">
            <h3 className="text-2xl font-bold text-gray-900 mb-4">How can we help you?</h3>
            <div className="grid md:grid-cols-3 gap-6">
              <div className="p-4 bg-sky-50 rounded-2xl">
                ...
                <p className="text-sm text-gray-600">Found an issue with one of our tools? Let us know so we can fix it immediately.</p>
              </div>
              <div className="p-4 bg-purple-50 rounded-2xl">
                <Mail className="text-purple-600 mb-3" size={28} />
                <h4 className="font-bold text-gray-900 mb-2">Tool Suggestions</h4>
                <p className="text-sm text-gray-600">Have an idea for a new converter or generator? We love hearing from users.</p>
              </div>
              <div className="p-4 bg-pink-50 rounded-2xl">
                <Twitter className="text-pink-600 mb-3" size={28} />
                <h4 className="font-bold text-gray-900 mb-2">General Inquiry</h4>
                <p className="text-sm text-gray-600">Questions about our privacy policy, terms, or business partnerships.</p>
              </div>
            </div>

            <div className="mt-8 pt-8 border-t border-gray-100">
              <p className="text-gray-600 mb-2">
                Generator PromptAI is a project dedicated to providing free, accessible AI tools and utilities. We are based in Karachi, Pakistan.
              </p>
              <p className="text-sm text-gray-500">
                Please note: We do not provide technical support for 3rd party AI models (like OpenAI or Midjourney), but we can help with the tools on this website.
              </p>
            </div>
          </div>
          {/* Related Tools */}
