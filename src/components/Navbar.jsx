...
const Navbar = () => {
  ...
  return (
    <>
      <Helmet> <title>Generator PromptAI – AI Prompt Generator Free for ChatGPT, Midjourney & more</title>
        <meta name="description" content="generator PromptAI is a free AI prompt generator that creates powerful prompts for ChatGPT, Claude, Gemini and Midjourney. Instantly generate optimized prompts for writing, coding, art and more." />
        ...
        <meta property="og:description" content="Generate powerful prompts for ChatGPT, Claude, Youtube and Midjourney. Plus access 30+ powerful free online tools." />
